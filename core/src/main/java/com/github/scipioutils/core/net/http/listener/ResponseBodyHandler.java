...
import com.github.scipioutils.core.net.http.HttpFileUtils;
import com.github.scipioutils.core.net.http.def.Request;
import com.github.scipioutils.core.net.http.def.Response;
import com.github.scipioutils.core.net.http.def.ResponseDataMode;
...
public interface ResponseBodyHandler {
     ...
     * @param request  请求参数
     */
    void handleInput(HttpURLConnection conn, Response response, Request request) throws Exception;

    /**
     * 默认实现
     */
    ResponseBodyHandler DEFAULT = (conn, response, request) -> {
